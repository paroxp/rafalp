module VConfig
  ...
  $config = {
      ...
      # PHP
      php:              false, # Should the PHP be installed?
      ...
      composer:         false, # Would you like to use beautiful and magical composer?
      ...
      mailcatcher:      false, # Would you like to install MailCatcher?
